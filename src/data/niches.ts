...
export const niches: NicheData[] = [
  {
    ...
    heroSub: 'Schluss mit Preiskämpfen und unqualifizierten Anfragen. Ich baue digitale Aushängeschilder für Hausmeisterservices und Facility Manager, die Premium-Kunden anziehen.',
    ...
    trustText: 'Diesen Facility-Management-Unternehmen helfen ich bereits beim Wachstum',
    ...
    faqs: [
      ...
      { question: 'Wie hilft mir lokale SEO dabei, mehr Aufträge in meiner Region zu gewinnen?', answer: 'Facility Management ist ein stark lokales Geschäft. Durch gezielte lokale Suchmaschinenoptimierung (Local SEO) stellen ich sicher, dass Ihr Unternehmen bei Suchanfragen wie "Gebäudereinigung [Stadt]" ganz oben auf Google erscheint.' },
      { question: 'Ich habe wenig Zeit. Wie viel Aufwand bedeutet die neue Website für mich?', answer: 'Mein Prozess ist "Done-for-You". Nach einem kurzen Strategiegespräch übernehmen ich Konzeption, Design, Texterstellung und technische Umsetzung komplett. Sie müssen lediglich die Entwürfe freigeben.' },
      { question: 'Können wir auch Mitarbeitergewinnung (Recruiting) über die Website abbilden?', answer: 'Absolut. Der Fachkräftemangel ist im Facility Management eine der größten Herausforderungen. Ich integriere auf Wunsch optimierte Karriere-Seiten und einfache, mobile Bewerbungsprozesse.' }
    ]
  },
  {
    slug: 'handwerker',
    ...
    heroSub: 'Raus aus der Vergleichbarkeit. Ich entwickle Webseiten für Handwerker, die Ihre handwerkliche Qualität digital sichtbar machen und die richtigen Kunden anziehen.',
    ...
    trustText: 'Diese Handwerksbetriebe vertrauen auf meine Expertise',
    trustLogos: ['Müller SHK', 'Elektro Schmidt', 'Dachdeckerei Weber'],
    benefits: [
      { icon: Smartphone, title: 'Mobile-First Design', description: 'Ihre Kunden suchen oft vom Smartphone aus nach Handwerkern. Ich optimiere Ihre Seite für perfekte mobile Darstellung und schnelle Ladezeiten.' },
    ...
    faqs: [
      ...
      { question: 'Wie gewinnen ich über die neue Website Fachkräfte?', answer: 'Ich baue spezielle Landingpages für Bewerber, die die Vorteile Ihres Betriebs (Benefits, Team-Kultur) hervorheben. Ein extrem vereinfachter Bewerbungsprozess (ohne langes Anschreiben) senkt die Hürde für wechselwillige Gesellen.' },
      { question: 'Schreiben Sie auch die Texte für meine Handwerker-Website?', answer: 'Ja, meine Copywriter erstellen verkaufspsychologisch optimierte Texte, die Ihre handwerkliche Expertise in den Vordergrund stellen und den Kunden den Mehrwert einer Zusammenarbeit mit Ihnen aufzeigen.' }
    ]
  },
  {
    slug: 'steuerberater',
    ...
    heroSub: 'Gewinnen Sie lukrative Wunschmandanten und qualifizierte Fachkräfte. Ich positioniere Ihre Kanzlei als modernen, digitalen Vorreiter in Ihrer Region.',
    ...
    trustText: 'Erfolgreiche Kanzleien, die mit mir wachsen',
    ...
    benefits: [
      ...
      { icon: Target, title: 'Fokus auf Wunschmandanten', description: 'Ich optimiere Ihre Seite so, dass Sie genau die Mandanten anziehen (z.B. mittelständische GmbHs, E-Commerce), die Sie wirklich betreuen möchten.' },
    ...
    faqs: [
      ...
      { question: 'Wie heben wir uns von anderen Kanzleien ab?', answer: 'Die meisten Kanzlei-Websites sehen identisch aus (Bilder von Aktenordnern, Taschenrechnern). Ich setze auf authentische Team-Fotos, klare Spezialisierungen und eine moderne Bildsprache, die Ihre Kanzlei menschlich und digital-affin zeigt.' },
      { question: 'Können Mandanten-Portale (z.B. DATEV Unternehmen online) integriert werden?', answer: 'Selbstverständlich. Ich binde Login-Bereiche für DATEV oder andere Mandanten-Portale nahtlos und sicher in Ihre neue Website ein.' }
    ]
  },
  {
    slug: 'rechtsanwaelte',
    ...
    heroSub: 'Positionieren Sie sich als führender Experte in Ihrem Rechtsgebiet. Ich entwickle Webseiten, die Vertrauen aufbauen und aus Website-Besuchern zahlende Mandanten machen.',
    ...
    trustText: 'Diese Kanzleien vertrauen auf meine digitale Expertise',
    ...
    faqs: [
      ...
      { question: 'Berücksichtigen Sie das anwaltliche Berufsrecht?', answer: 'Ja, ich achte bei der Gestaltung und Strukturierung strikt auf die Einhaltung berufsrechtlicher Vorgaben (z.B. Impressumspflichten, korrekte Bezeichnung von Fachanwaltschaften).' },
      { question: 'Können wir einen Blog für rechtliche Updates integrieren?', answer: 'Ein Rechts-Blog ist ein hervorragendes SEO-Tool. Ich integriere ein einfach zu bedienendes CMS, mit dem Sie aktuelle Urteile und Ratgeber-Artikel veröffentlichen können, um Ihre Expertise zu unterstreichen.' }
    ]
  },
  {
  ...
  },
  {
    ...
    heroSub: 'Von der Prophylaxe bis zur Implantologie: Ich positioniere Ihre Zahnarztpraxis als moderne Wohlfühl-Klinik und ziehen genau die Patienten an, die Sie behandeln möchten.',
    schemaDescription: 'Webdesign und lokales SEO für Zahnärzte, Kieferorthopäden und Implantologen. Mehr Neupatienten gewinnen.',
    trustText: 'Diese Praxen vertrauen auf meine digitalen Lösungen',
    ...
    faqs: [
      { question: 'Wie heben wir uns von anderen Zahnärzten in der Stadt ab?', answer: 'Ich rücke Ihr Team, Ihre modernen Räumlichkeiten und Ihre Spezialisierungen in den Fokus. Authentische Bilder und Patientenstimmen schaffen einen emotionalen Bezug, den Standard-Webseiten nicht bieten.' },
      ...
      { question: 'Können Sie uns auch bei der Suche nach ZFA (Zahnmedizinischen Fachangestellten) helfen?', answer: 'Ja, ich integriere eine moderne Karriereseite, die Ihre Praxis als Top-Arbeitgeber präsentiert und den Bewerbungsprozess für ZFAs und ZMPs extrem vereinfacht.' }
    ]
  },
  {
    ...
    heroSub: 'Präsentieren Sie Ihre Behandlungsmethoden professionell. Ich baue Webseiten für Physiotherapeuten, die Vertrauen aufbauen und die Terminvereinbarung kinderleicht machen.',
    ...
    trustText: 'Erfolgreiche Praxen, die mit mir digital durchstarten',
    ...
    faqs: [
      ...
      { question: 'Können wir meine Kursangebote (z.B. Yoga, Pilates) integrieren?', answer: 'Ja, ich kann übersichtliche Kurspläne, Beschreibungen und direkte Online-Anmeldemöglichkeiten für Ihre Präventions- und Selbstzahlerkurse integrieren.' },
      { question: 'Wie aufwendig ist die Pflege der Website für mich?', answer: 'Sehr gering. Ich nutze ein benutzerfreundliches System. Sie können Teammitglieder, Öffnungszeiten oder neue Leistungen ganz einfach selbst anpassen – oder Sie nutzen meinen Wartungsservice.' }
    ]
  },
  {
    slug: 'pflegedienste',
    ...
    heroSub: 'Zeigen Sie, dass bei Ihnen der Mensch im Mittelpunkt steht. Ich entwickle Webseiten für Pflegedienste, die Vertrauen bei Angehörigen schaffen und Pflegekräfte magnetisch anziehen.',
    schemaDescription: 'Webdesign und Recruiting-Lösungen für ambulante Pflegedienste und Tagespflegen.',
    trustText: 'Pflegedienste, die mit mir wachsen und rekrutieren',
    ...
    faqs: [
      { question: 'Wie hilft die Website konkret beim Recruiting von Pflegekräften?', answer: 'Pflegekräfte sind extrem umkämpft. Ihre Website muss sofort zeigen, warum es toll ist, bei Ihnen zu arbeiten. Ich kombiniere emotionale Mitarbeiter-Videos, klare Benefits und ein Formular, das ohne Lebenslauf in 1 Minute ausfüllbar ist.' },
      { question: 'Ist die Website auch für ältere Menschen gut bedienbar?', answer: 'Ja, ich achte auf Barrierefreiheit, große Schriften, hohe Kontraste und eine extrem einfache Navigation, damit sowohl Senioren als auch deren Angehörige sich mühelos zurechtfinden.' },
      { question: 'Können wir Beratungsangebote digitalisieren?', answer: 'Ich kann Formulare für Erstgespräche oder Checklisten zur Pflegegrad-Beantragung integrieren, was Ihnen Zeit spart und den Angehörigen sofortigen Mehrwert bietet.' }
    ]
  },
  {
    ...
    faqs: [
      { question: 'Wie generieren wir über die Website Termine mit Geschäftsführern?', answer: 'Entscheider suchen nach Lösungen, nicht nach Beratern. Ich strukturiere Ihre Website um die spezifischen Schmerzpunkte (Pain Points) Ihrer Zielgruppe und biete niedrigschwellige Einstiege wie Potenzialanalysen oder Strategie-Calls an.' },
      { question: 'Können wir meine Case Studies professionell einbinden?', answer: 'Ja, Case Studies sind Ihr stärkstes Verkaufsinstrument. Ich entwickle ein spezielles Portfolio-Layout, das die Ausgangssituation, Ihre Lösung und die messbaren Ergebnisse (ROI) für vergangene Klienten eindrucksvoll präsentiert.' },
      { question: 'Bieten Sie auch Unterstützung bei LinkedIn-Kampagnen an?', answer: 'Ihre neue Website ist die perfekte Zielseite (Landingpage) für Ihre LinkedIn-Aktivitäten. Ich optimiere die Seite so, dass der Traffic aus Ihren LinkedIn-Posts optimal konvertiert.' }
    ]
  },
  {
    ...
    benefits: [
      { icon: Zap, title: 'Nutzen statt Features', description: 'Ich kommuniziere nicht über Server-Spezifikationen, sondern über Ausfallsicherheit, Produktivität und Kosteneinsparungen für Ihre Kunden.' },
      ...
      { icon: Users, title: 'IT-Recruiting', description: 'Entwickler und Admins sind schwer zu finden. Ich baue Karriereseiten, die Ihre Tech-Stack, Ihre Kultur und Ihre Benefits perfekt präsentieren.' }
    ],
    faqs: [
  ...
  },
  {
    ...
    faqs: [
      { question: 'Wie schaffen wir es, dass Interessenten uns ihre Finanzen anvertrauen?', answer: 'Vertrauen entsteht durch Transparenz und Autorität. Ich rücke Ihre Qualifikationen, Kundenstimmen und Ihre persönliche Philosophie in den Vordergrund. Ein professionelles, ruhiges Design tut sein Übriges.' },
      { question: 'Können wir Terminbuchungstools wie Calendly integrieren?', answer: 'Ja, die direkte Buchung eines kostenlosen Erstgesprächs (Discovery Call) ist der effektivste Weg zur Mandantengewinnung. Ich binde diese Tools nahtlos in die Website ein.' },
      { question: 'Wie können ich komplexe Finanzprodukte einfach erklären?', answer: 'Ich nutze klare Infografiken, strukturierte Leistungsseiten und nutzenorientierte Texte, um Themen wie ETF-Portfolios, Baufinanzierungen oder Altersvorsorge für Laien verständlich zu machen.' }
    ]
  },
  {
    slug: 'architekten',
    ...
    heroSub: 'Lassen Sie Ihre Referenzen für sich sprechen. Ich entwickle minimalistische, bildgewaltige Webseiten, die Bauherren und Investoren von Ihrer architektonischen Handschrift überzeugen.',
    ...
    trustText: 'Architekturbüros, deren Visionen ich digitalisiere',
    trustLogos: ['Studio Architektur', 'Planungsbüro Nord', 'Design & Build'],
    benefits: [
      { icon: Camera, title: 'Bildgewaltiges Portfolio', description: 'Ihre Projekte stehen im Mittelpunkt. Ich nutze großflächige Bilder, sanfte Animationen und ein klares Grid-System für maximale visuelle Wirkung.' },
      ...
      { icon: Target, title: 'Gezielte Bauherren-Ansprache', description: 'Egal ob private Bauherren, Gewerbebau oder öffentliche Hand – ich strukturiere die Seite so, dass Ihre Wunsch-Zielgruppe direkt angesprochen wird.' }
    ],
    faqs: [
      { question: 'Meine Projekte leben von großen Bildern. Macht das die Website nicht langsam?', answer: 'Nein. Ich nutze modernste Bildkomprimierung (WebP), Lazy-Loading und ein globales Content Delivery Network (CDN), damit Ihre hochauflösenden Renderings und Fotos blitzschnell laden.' },
      { question: 'Wie können wir unsere Philosophie und Arbeitsweise vermitteln?', answer: 'Neben dem Portfolio integrieren ich eine starke "Über uns"-Sektion, die Ihren Designansatz, Ihr Team und Ihre Methodik (z.B. BIM, nachhaltiges Bauen) authentisch transportiert.' },
      { question: 'Gewinnen ich über die Website auch neue Mitarbeiter?', answer: 'Ja, gute Architekten und Bauzeichner achten extrem auf die digitale Präsenz ihres zukünftigen Arbeitgebers. Eine ästhetische Website ist Ihr bestes Recruiting-Tool.' }
    ]
  },
  {
    ...
    benefits: [
      ...
      { icon: Zap, title: 'Nahtlose Jobbörsen-Integration', description: 'Ich binde Ihre ATS-Software (z.B. Personio, Softgarden) ein, sodass Ihre Stellenanzeigen automatisch auf der Website erscheinen und bewerbbar sind.' },
  ...
  },
  {
    ...
    heroSub: 'Zeigen Sie Ihre Leistungsfähigkeit. Ich entwickle Webseiten für Speditionen, die internationale Kunden überzeugen und dem Fahrermangel aktiv entgegenwirken.',
    ...
    trustText: 'Logistikunternehmen, die mit mir auf der Überholspur sind',
    trustLogos: ['TransLogistics', 'Global Freight', 'Express Kurier'],
    benefits: [
      { icon: Users, title: 'Fahrer-Recruiting', description: 'Der Fahrermangel ist das größte Problem der Branche. Ich baue Landingpages, die Ihre Benefits (z.B. pünktliche Bezahlung, moderner Fuhrpark) zeigen und mobile Bewerbungen ermöglichen.' },
    ...
    faqs: [
      { question: 'Wie überzeugen wir LKW-Fahrer, sich bei mir zu bewerben?', answer: 'Fahrer sind viel unterwegs und nutzen fast nur das Smartphone. Ihre Karriereseite muss mobil perfekt funktionieren. Ich nutze authentische Bilder Ihres Fuhrparks und ein Bewerbungsformular, das in 1 Minute ohne Lebenslauf ausfüllbar ist.' },
      { question: 'Macht eine mehrsprachige Website Sinn?', answer: 'Wenn Sie im internationalen Fernverkehr tätig sind oder internationale Kunden haben: Ja. Ich setze mehrsprachige Websites (z.B. DE/EN/PL) SEO-optimiert und benutzerfreundlich um.' },
      { question: 'Können wir meine Zertifikate und Sicherheitsstandards hervorheben?', answer: 'Das ist sogar essenziell für B2B-Auftraggeber. Ich platziere Ihre Zertifizierungen (TAPA, GDP, ISO) prominent als Trust-Elemente auf der Startseite.' }
    ]
  },
  {
    ...
    heroSub: 'Raus aus dem Preiskampf bei Privatkunden. Ich positioniere Ihre Reinigungsfirma als zuverlässigen Partner für Büros, Praxen und Industrieanlagen.',
    schemaDescription: 'Webdesign und lokales SEO für Gebäudereinigungen und Reinigungsfirmen. Fokus auf Gewerbekunden (B2B).',
    trustText: 'Reinigungsunternehmen, die mit mir wachsen',
    trustLogos: ['Glanz & Sauber', 'ProClean Gebäudeservice', 'Meister-Reinigung'],
    benefits: [
      { icon: Target, title: 'B2B-Fokus', description: 'Ich richte Ihre Website gezielt auf lukrative Unterhaltsreinigungen für Gewerbe, Industrie und medizinische Einrichtungen aus.' },
      ...
      { icon: Users, title: 'Personal finden', description: 'Zuverlässiges Reinigungspersonal ist schwer zu finden. Ich integriere einfache, mehrsprachige Bewerbungsformulare für neue Mitarbeiter.' }
    ],
    faqs: [
      { question: 'Wie kommen wir an mehr gewerbliche Aufträge?', answer: 'Gewerbekunden suchen online nach Zuverlässigkeit und Professionalität. Ich hebe Ihre Qualitätsstandards, Zertifikate und Referenzen hervor und integrieren ein Formular für eine schnelle, unverbindliche Objektbesichtigung.' },
      ...
      { question: 'Können wir Spezialreinigungen (z.B. Solar, Fassade) extra bewerben?', answer: 'Ja, ich erstelle für jede Ihrer Spezialleistungen eigene, SEO-optimierte Unterseiten. So werden Sie auch für Nischen-Suchanfragen regional gefunden.' }
    ]
  },
  {
    ...
    heroSub: 'Vom Vorgarten bis zur Großanlage: Ich baue Webseiten für den GaLaBau, die Ihre schönsten Projekte präsentieren und kaufkräftige Kunden anziehen.',
    schemaDescription: 'Webdesign und SEO für Garten- und Landschaftsbau (GaLaBau). Mehr Premium-Aufträge und Mitarbeitergewinnung.',
    trustText: 'GaLaBau-Betriebe, die mit mir digital wachsen',
    ...
    benefits: [
      ...
      { icon: Target, title: 'Fokus auf Premium-Aufträge', description: 'Ich positioniere Sie weg vom reinen "Rasenmäher" hin zum Experten für hochwertige Gartengestaltung und Komplettumbauten.' },
    ...
    faqs: [
      { question: 'Wie zeigen wir meine Vielseitigkeit (Pflasterarbeiten, Pflanzen, Pools)?', answer: 'Ich strukturiere Ihre Leistungen übersichtlich in eigene Kategorien. So findet der Kunde, der einen Pool sucht, genauso schnell die richtigen Informationen wie der Kunde für Pflasterarbeiten.' },
      { question: 'Können Kunden direkt online Anfragen stellen?', answer: 'Ja, ich integriere intelligente Projekt-Anfrageformulare. Kunden können direkt angeben, was sie planen (z.B. Neuanlage, Budgetrahmen) und Fotos ihres aktuellen Gartens hochladen.' },
      { question: 'Wie werden wir in meiner Region besser gefunden?', answer: 'Durch gezielte lokale Suchmaschinenoptimierung (Local SEO) für Begriffe wie "Gartengestaltung [Stadt]" oder "Terrassenbau [Region]" sorge ich dafür, dass Sie bei Google dominieren.' }
    ]
  },
  {
    ...
    h1Highlight: 'die Vertrauen schafft.',
    heroSub: 'Machen Sie sich unabhängig von Werkstatt-Portalen. Ich baue digitale Präsenzen für freie KFZ-Werkstätten, die lokale Sichtbarkeit garantieren und die Terminvereinbarung digitalisieren.',
    ...
    trustText: 'Werkstätten, die mit mir auf der Überholspur sind',
    ...
    benefits: [
      ...
      { icon: ShieldCheck, title: 'Vertrauen & Transparenz', description: 'Ich präsentiere Ihr Meister-Team, Ihre moderne Werkstattausrüstung und echte Kundenbewertungen, um Vertrauen aufzubauen.' }
    ],
    faqs: [
      ...
      { question: 'Können wir spezielle Leistungen (z.B. E-Auto Service, Smart Repair) hervorheben?', answer: 'Unbedingt. Spezialisierungen sind Ihr größter Wettbewerbsvorteil. Ich erstelle dafür eigene Landingpages, damit Sie genau für diese lukrativen Suchanfragen bei Google gefunden werden.' },
      { question: 'Helfen Sie uns auch bei der Suche nach Mechatronikern?', answer: 'Ja, der Fachkräftemangel trifft Werkstätten hart. Ich integriere eine Karriereseite mit einfacher mobiler Bewerbung, um wechselwillige KFZ-Mechatroniker in Ihrer Region anzusprechen.' }
    ]
  },
  {
    slug: 'eventagenturen',
    ...
    heroSub: 'Ihre Events sind spektakulär – Ihre Website sollte es auch sein. Ich kreiere digitale Erlebnisse für Eventagenturen, die B2B-Entscheider und Marken restlos überzeugen.',
    schemaDescription: 'Premium Webdesign für Eventagenturen, Messebauer und Hochzeitsplaner. Fokus auf Portfolio und B2B-Kunden.',
    trustText: 'Agenturen, deren digitale Bühne ich gebaut habe',
    ...
    faqs: [
      { question: 'Wie präsentieren wir meine Case Studies am besten?', answer: 'Ich strukturiere Ihre Case Studies als spannende Storys: Ausgangslage des Kunden, Ihre kreative Leitidee und das emotionale (und messbare) Ergebnis – untermauert mit starken Bildern und Aftermovies.' },
      { question: 'Ist eine so bildlastige Website nicht schlecht für SEO?', answer: 'Nicht, wenn sie richtig programmiert ist. Ich optimiere alle Medien, nutzen saubere semantische HTML-Strukturen und integrieren SEO-Texte so, dass sie das Design nicht stören, aber von Google perfekt gelesen werden.' },
      { question: 'Können wir auch meine eigenen Event-Formate oder Tickets vermarkten?', answer: 'Ja, ich kann nahtlos Ticketing-Systeme (wie Eventbrite oder eigene Lösungen) integrieren, um Ihre Eigenveranstaltungen direkt über die Website zu verkaufen.' }
    ]
  },
  {
    slug: 'fotografen',
    ...
    heroSub: 'Ihre Bilder sind Kunstwerke. Ich baue den perfekten digitalen Rahmen dafür. Minimalistisch, blitzschnell und optimiert, um aus Betrachtern zahlende Kunden zu machen.',
    ...
    trustText: 'Kreative, die ihre Kunst mit mir digital präsentieren',
    ...
    benefits: [
      ...
      { icon: Target, title: 'Gezielte Kundenansprache', description: 'Egal ob B2B-Werbefotografie oder Hochzeitsvideografie – ich strukturiere die Seite so, dass Ihre Wunschzielgruppe direkt konvertiert.' }
    ],
    faqs: [
      { question: 'Wie schützen Sie meine Bilder vor Diebstahl?', answer: 'Ich kann Rechtsklick-Sperren und unsichtbare Wasserzeichen integrieren. Wichtiger ist jedoch die technische Optimierung, sodass Bilder in Web-Auflösung geladen werden, die für den Druck unbrauchbar ist.' },
      { question: 'Können Kunden direkt Termine oder Pakete buchen?', answer: 'Ja, ich kann Buchungssysteme für Shootings (z.B. Bewerbungsfotos, Mini-Shootings) integrieren, inklusive Kalendersynchronisation und Online-Bezahlung.' },
      { question: 'Wie werde ich für bestimmte Fotografie-Arten bei Google gefunden?', answer: 'Ich erstelle für Ihre Schwerpunkte (z.B. "Hochzeitsfotograf München" oder "Businessfotografie Berlin") eigene, SEO-optimierte Landingpages, die regional Top-Rankings erzielen.' }
    ]
  },
  {
    slug: 'fitnessstudios',
    ...
    faqs: [
      { question: 'Wie heben wir uns von den großen Billig-Ketten ab?', answer: 'Indem ich den Fokus auf Ihre Betreuungsqualität, die Community und die Atmosphäre lege. Ich nutze hochwertige Bilder und Videos, die das "Gefühl" in Ihrem Studio transportieren – etwas, das Discounter nicht bieten können.' },
      { question: 'Können wir Online-Mitgliedschaften verkaufen?', answer: 'Ja, ich kann den kompletten Anmeldeprozess digitalisieren. Interessenten können Verträge online abschließen, was die Hürde senkt und Ihr Personal am Empfang entlastet.' },
      { question: 'Wie gewinnen ich Personal Training Klienten?', answer: 'Für High-Ticket-Angebote wie Personal Training setzen ich auf Vertrauensaufbau durch Experten-Positionierung, Kunden-Testimonials und ein Bewerbungs-Formular für ein kostenloses Erstgespräch.' }
    ]
  },
  {
    slug: 'gastronomie',
    ...
    heroSub: 'Das Auge isst auch digital mit. Ich entwickle Webseiten für Restaurants und Caterer, die das Ambiente einfangen, Reservierungen steigern und Events verkaufen.',
    ...
    trustText: 'Gastronomen, deren Tische ich digital füllen',
    ...
    faqs: [
      { question: 'Können wir meine Speisekarte einfach selbst aktualisieren?', answer: 'Ja, ich integriere ein extrem einfaches System, mit dem Sie Tageskarten, Preise oder saisonale Gerichte in Sekunden vom Smartphone aus ändern können – ohne PDF-Uploads.' },
      { question: 'Wie werden wir von Touristen oder neuen Gästen besser gefunden?', answer: 'Ich optimiere Ihre Website für lokale Suchanfragen (z.B. "Italiener [Stadtmitte]") und verknüpfe sie perfekt mit Ihrem Google Business Profil, um in den lokalen Suchergebnissen ganz oben zu stehen.' },
      { question: 'Helfen Sie auch bei der Mitarbeitersuche (Service/Küche)?', answer: 'Der Personalmangel in der Gastro ist enorm. Ich baue eine Karriereseite, die Ihre Vorteile als Arbeitgeber zeigt und eine Bewerbung per Smartphone in unter einer Minute ermöglicht.' }
    ]
  }
];
