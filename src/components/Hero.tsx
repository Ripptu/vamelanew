...
export function Hero({ onOpenContact }: { onOpenContact: () => void }) {
  ...
  return (
    <section 
      className="relative w-full pt-28 pb-16 md:pt-36 md:pb-28 lg:pt-48 lg:pb-36 px-4 sm:px-6 lg:px-8 text-center overflow-hidden bg-warm-50"
    ...
    >
      ...
      <div className="relative z-20 max-w-5xl mx-auto flex flex-col items-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/90 border border-slate-200/80 shadow-xs mb-6 text-xs sm:text-sm font-medium text-slate-700 backdrop-blur-xs"
        >
        ...
        <motion.h1 
          ...
          className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-4 md:mb-8 leading-[1.15] md:leading-[1.06] text-slate-950"
        >
        ...
        <motion.p 
          ...
          className="text-base sm:text-lg md:text-xl text-slate-700 mb-8 md:mb-12 max-w-2xl mx-auto leading-relaxed px-2 sm:px-0"
        >
        ...
        >
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4 w-full sm:w-auto">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group w-full sm:w-auto bg-primary hover:bg-primary-hover text-white px-6 py-4 sm:px-8 sm:py-4 rounded-full font-medium text-base md:text-lg flex items-center justify-center gap-2 transition-colors relative overflow-hidden shadow-sm focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary focus-visible:outline-none"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="group w-full sm:w-auto bg-[#25D366] hover:bg-[#1da851] text-white px-6 py-4 sm:px-8 sm:py-4 rounded-full font-medium text-base md:text-lg flex items-center justify-center gap-2 transition-colors shadow-sm focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#25D366] focus-visible:outline-none"
            >
            ...
            <div className="flex -space-x-3">
              {[
                ...
                <motion.div 
                  ...
                  className="relative w-10 h-10 sm:w-12 sm:h-12 rounded-full border-2 border-white bg-slate-200 overflow-hidden cursor-pointer shadow-xs"
                >
                  <img src={src} alt="Kundenreferenz" width="48" height="48" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                </motion.div>
              ))}
            </div>
