      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center max-w-5xl mx-auto">
          ...
          <motion.div 
            ...
            className="bg-white p-8 md:p-12 rounded-[2rem] border border-slate-200 flex flex-col relative z-10"
          >
            <div className="mb-8">
              <div className="w-14 h-14 bg-slate-50 text-slate-700 rounded-2xl flex items-center justify-center mb-6 border border-slate-100">
          ...
          <motion.div 
            ...
            whileHover={{ y: -8, transition: { duration: 0.3 } }}
            className="bg-white p-8 md:p-12 rounded-[2rem] border-2 border-primary flex flex-col relative z-20 md:-ml-4 lg:-ml-8 md:scale-105"
          >
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-primary text-white px-6 py-1.5 rounded-full text-sm font-bold tracking-wide flex items-center gap-2 border border-white">
              <Sparkles className="w-4 h-4" />
              Am beliebtesten
            </div>
            
            <div className="mb-8 mt-4 relative z-10">
              <div className="w-14 h-14 bg-slate-50 text-primary rounded-2xl flex items-center justify-center mb-6 border border-slate-200">
                <Calendar className="w-7 h-7" strokeWidth={1.5} />
              </div>
              <h3 className="text-2xl md:text-3xl font-bold text-slate-900 mb-3">Monats-Abo</h3>
              <p className="text-slate-500 leading-relaxed">
