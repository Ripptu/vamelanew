    ...
    <>
      <div className={`fixed top-0 left-0 right-0 z-50 transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
        ...
        <div className="hidden lg:flex items-center gap-8 text-sm font-medium text-slate-600 bg-white/90 backdrop-blur-md border border-slate-200 rounded-full px-6 py-3 shadow-sm absolute left-1/2 -translate-x-1/2">
          ...
          <a href="/#zahlung" aria-label="Zur Bezahlung" className="hover:text-slate-900 transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-md px-2 py-1">Bezahlung</a>
        </div>
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-center px-8 gap-8">
              ...
              <a href="/#zahlung" onClick={() => setIsMenuOpen(false)} className="text-5xl sm:text-6xl font-black text-white uppercase tracking-tighter hover:text-primary transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-md">Bezahlung</a>
            </div>
