    ...
    <section id="gratis-entwurf" className="py-16 md:py-32 bg-white relative overflow-hidden" aria-labelledby="free-draft-title">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
        <motion.div 
          ...
          className="bg-white p-6 sm:p-10 md:p-14 rounded-3xl md:rounded-[2.5rem] border border-slate-100 shadow-2xl shadow-black/5 relative overflow-hidden"
        >
          ...
          <div className="text-center mb-8 md:mb-12 relative z-10">
            <div className="w-12 h-12 md:w-16 md:h-16 bg-slate-50 text-slate-900 rounded-xl md:rounded-2xl flex items-center justify-center mx-auto mb-4 md:mb-6 shadow-sm border border-slate-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6 max-w-3xl mx-auto relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              <div className="space-y-1.5 md:space-y-2">
                <label htmlFor="draft-name" className="block text-xs md:text-sm font-medium text-slate-700 ml-1">Wer bist du?</label>
                <input 
                  id="draft-name"
                  required
                  type="text" 
                  className="w-full px-4 py-3 md:px-5 md:py-4 rounded-xl md:rounded-2xl border border-slate-200/60 bg-slate-50/50 focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-slate-400 text-sm md:text-base text-slate-900"
              ...
              <div className="space-y-1.5 md:space-y-2">
                <label htmlFor="draft-business" className="block text-xs md:text-sm font-medium text-slate-700 ml-1">Was machst du?</label>
                <input 
                  id="draft-business"
                  required
                  type="text" 
            ...
            <div className="space-y-1.5 md:space-y-2">
              <label htmlFor="draft-goal" className="block text-xs md:text-sm font-medium text-slate-700 ml-1">Was willst du mit deiner Website erreichen?</label>
              <textarea 
                id="draft-goal"
                required
            ...
            <div className="space-y-1.5 md:space-y-2">
              <label htmlFor="draft-style" className="block text-xs md:text-sm font-medium text-slate-700 ml-1">Gewünschter Stil?</label>
              <input 
                id="draft-style"
                type="text"
                className="w-full px-4 py-3 md:px-5 md:py-4 rounded-xl md:rounded-2xl border border-slate-200/60 bg-slate-50/50 focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all placeholder:text-slate-400 text-sm md:text-base text-slate-900"
            ...
            <div className="pt-4 md:pt-6">
              <button
                type="submit"
                className="group w-full bg-slate-900 hover:bg-slate-800 text-white py-3 md:py-4 px-6 md:px-8 rounded-full font-medium text-base md:text-lg flex items-center justify-center gap-3 transition-all shadow-md focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-slate-900 focus-visible:outline-none"
              >
